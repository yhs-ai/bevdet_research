...
_base_ = ['../_base_/datasets/nus-3d-temporal.py',
...
model = dict(
    ...
    img_neck=dict(
        ...
        scale_factor=2),
    img_view_transformer=dict(type='ViewTransformerLiftSplatShootTemporal_DFE',
...
train_pipeline = [
    dict(type='LoadMultiViewImageFromFiles_BEVDetTemporal', is_train=True, data_config=data_config),
    dict(
...
test_pipeline = [
    dict(type='LoadMultiViewImageFromFiles_BEVDetTemporal', data_config=data_config),
